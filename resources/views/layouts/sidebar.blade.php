<aside class="w-64 bg-primary-800 text-white flex-shrink-0 hidden md:flex md:flex-col shadow-lg z-20 h-screen sticky top-0">
    ...
    <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="#" class="flex items-center px-4 py-3 text-sm font-medium rounded-md text-primary-100 hover:bg-primary-700 hover:text-white group transition-colors">
            <svg class="mr-3 h-5 w-5 text-primary-300 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
